...
<body>
	<div class="container">
		...
		<div class="main">
			<div class="head">
				<span class="title">졸 업 증 명 서</span>
			</div>
			<div class="body">
				<div class="name">
				...
				<div class="name">
					<div class="number">졸업대장번호</div>
					<div class="my">: ${number}</div>
				</div>
				<div class="name">
					<div class="info">학교</div>
					<div class="my">: KH대학교</div>
				</div>
			</div>
			<div class="contents">위 사람은 2021년 03월 8일 전과정을 졸업하였음을 증명합니다.</div>
			<div class="foot">
				<div class="day">${today}</div>
				<div class="school">K H 대 학 교 장</div>
			</div>
		</div>
		<div class="bottom">
