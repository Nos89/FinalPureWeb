...
<body>
	<div class="container">
		...
		<div class="main">
			<div class="head">
				<span class="title">추 천 서</span>
			</div>
			<div class="body">
				<div class="name">
					<div class="info">성명</div>
					<div class="my">: ${name}</div>
				</div>
				<div class="name">
					<div class="number">생년월일</div>
					<div class="my">: ${birthday}</div>
				</div>
				<div class="name">
					<div class="info">대학</div>
					<div class="my">: ${col}</div>
				</div>
				<div class="name">
					<div class="info">학과</div>
					<div class="my">: ${dept}</div>
				</div>
			</div>
			<div class="contents">위 사람은 우리 학교의 자랑입니다.</div>
			<div class="foot">
				<div class="day">${today}</div>
				<div class="school">
					<img id="img2" src="/resources/img/certification/reference.jpg">
				</div>
			</div>
		</div>
		<div class="bottom">
