...
<div class="col-2">
	<div class="row text-center leftMenu">
		...
		<div class="col-12">
			<ul class="list-group">
				<li class="list-group-item"><a href="/main?pageGroup=certificate&type=academicIssuance">학적 증명서 발급</a></li>
				<li class="list-group-item"><a href="/main?pageGroup=certificate&type=studentID">학생증 발급</a></li>
			</ul>
		</div>
	</div>
</div>
