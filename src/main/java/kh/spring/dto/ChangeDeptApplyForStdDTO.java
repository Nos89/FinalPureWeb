...
public class ChangeDeptApplyForStdDTO {
	private String id;
	...
	public ChangeDeptApplyForStdDTO() {
		super();
		// TODO Auto-generated constructor stub
	}
	public ChangeDeptApplyForStdDTO(String id, int changeYear, String changeSemester, String reason,
			String changeCollege, String changeDept) {
		super();
		this.id = id;
