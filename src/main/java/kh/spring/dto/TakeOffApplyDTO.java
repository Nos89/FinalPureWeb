...
public class TakeOffApplyDTO {
	...
	public TakeOffApplyDTO(String id, String reason, int takeOff_Year, String takeOff_Semester, int expectedReturnYear) {
		super();
		this.id = id;
		this.reason = reason;
	...
	// 신청 수리용
	public TakeOffApplyDTO(int seq, String id, String name, String col_title, String dept_title, String reason,
			int takeOff_Year, String takeOff_Semester, int expectedReturnYear, Date apply_date, String apply_approve) {
		super();
		this.seq = seq;
		this.id = id;
		this.name = name;
