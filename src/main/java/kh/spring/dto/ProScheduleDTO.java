...
public class ProScheduleDTO {
	...
	public ProScheduleDTO(int sche_seq, String sche_proId, String sche_proName, String sche_contents, Date sche_date,
			String sche_title, String sche_type, String check) {
		super();
