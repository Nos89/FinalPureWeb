...
public class AdminController {
	...
	public NexacroResult searchNotice(@ParamVariable(name = "sTarget") String target,
			@ParamVariable(name = "sKeyword") String keyword, @ParamVariable(name = "category") String category)
			throws Exception {
		NexacroResult nr = new NexacroResult();
	...
	public NexacroResult searchBoard(@ParamVariable(name = "sTarget") String target,
			@ParamVariable(name = "sKeyword") String keyword, @ParamVariable(name = "boardType") String boardType)
			throws Exception {
		NexacroResult nr = new NexacroResult();
	...
	public NexacroResult deleteBoard(@ParamDataSet(name = "in_board") List<BoardDTO_NEX> list,
			@ParamVariable(name = "boardType") String boardType) throws Exception {
	...
	public NexacroResult delFile(@ParamVariable(name = "fileSeq") int fileSeq,
			@ParamVariable(name = "parent_code") int parent_code, @ParamVariable(name = "name") String name) {
	...
	public NexacroResult searchTimetable(@ParamVariable(name = "classroom") String classroom,
			@ParamVariable(name = "year") String year, @ParamVariable(name = "semester") int semester) {
		NexacroResult nr = new NexacroResult();
	...
	public NexacroResult updColSchedule(@ParamDataSet(name = "in_colScheduler") ColScheduleDTO_NEX dto,
